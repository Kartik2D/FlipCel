...
export { InkwellToolSettingsPanel } from "./panels/tool-settings-panel";
...
export { InkwellHistoryPanel } from "./panels/history-panel";
...
declare global {
  interface HTMLElementTagNameMap {
    ...
    "inkwell-tool-settings-panel": import("./panels/tool-settings-panel").InkwellToolSettingsPanel;
    "inkwell-universal-panel": import("./panels/settings-panel").InkwellUniversalPanel;
    "inkwell-history-panel": import("./panels/history-panel").InkwellHistoryPanel;
